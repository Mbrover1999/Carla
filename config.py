...
TRAFFIC_LIGHT_CREEP_TARGET_SPEED_KMH = 5.0
TRAFFIC_LIGHT_CREEP_MAX_SPEED_KMH = 5.5
...
STOP_SIGN_CREEP_TARGET_SPEED_KMH = 5.0
STOP_SIGN_CREEP_MAX_SPEED_KMH = 5.5
STOP_SIGN_CREEP_THROTTLE = 0.14
