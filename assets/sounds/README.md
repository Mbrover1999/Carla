...
The WAV files in this directory come from the SFXMint "Crisp UI sound
set" and are distributed under CC0 1.0.

- `adas_warning.wav`: Glassy Notification Chime 14
